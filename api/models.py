...
# 关联查询GenericForeignKey，GenericRelation
...
class Scholarship(models.Model):
    ...
    class Meta:verbose_name_plural = '05.学位课程奖学金'
...
class Course(models.Model):
    ...
    sub_category = models.ForeignKey("CourseSubCategory",verbose_name='课程子类')

    course_type_choices = ((0, '付费'), (1, 'VIP专享'), (2, '学位课程'))
    course_type = models.SmallIntegerField(choices=course_type_choices,verbose_name='课程类型')

    degree_course = models.ForeignKey("DegreeCourse", blank=True, null=True, help_text="若是学位课程，此处关联学位表",verbose_name='学位课')
    ...
    class Meta:
        verbose_name_plural = '06.课程或学位课模块'
