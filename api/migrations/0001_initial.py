# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-05-31 19:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommend_courses', models.ManyToManyField(blank=True, related_name='recommend_by', to='api.Course', verbose_name='推荐课程')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name_plural': '05.学位课程奖学金',
            },
        ),
        migrations.CreateModel(
            name='Teacher',
